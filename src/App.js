      ...
      <header className="hero">
        <motion.div {...fadeIn}>
          ...
          <div className="social-links">
            <br></br>
            <a href="https://linkedin.com/in/achintya-jaimini" target="_blank" rel="noreferrer"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#0077B5">
